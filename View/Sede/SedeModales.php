...
// llamamos la clase y verificamos si ya existe info de este dato que llega
    $indicativa = new Indicativa( ' id_indicativa  ' , $llave_Primaria_Contructor);
...
if ($id == 1 && $permisos)
{
    ...
    <div class="carga_Documento">
        ...
        <div>        
            <input type="submit" title="ACEPTA <?= $accion ?> EL ITEM ELEGIDO"  value="<?= $accion ?>" name="accionU" id="accionU" onclick="envioInfoeT( null , `<?= $var_inf ?>`  ,  'tablareporte' , `View/Sede/SedeModales.php` ,  event , 'ele' )" >
        </div>
    </div>    
<?PHP
}

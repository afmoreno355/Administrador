...
if ($ingreso === false && $permisos->getIdTipo() !== "SA") {
    ...
    $contratos = Contratos::datosobjetos($filtro, $pagina, 20);
    // numero de paginas para la paginacion
    $numeroPaginas = ceil(Contratos::count($filtro)[0][0] / 20);
    ...
    <div class="botonMenu" style="font-weight: bolder; font-size: 2em; ">
        <button type='button' id='button' class="ele" title='Adicionar nuevo'  onclick="validarDatos(``, `I=<?= $var_add ?>`, `modalVentana`, `View/Cargo/CargoModales.php`, event, 'ele')"><img src="img/icon/adds.png"/> ADICIONAR<br>CONTRATO</button>
    ...
    <table id="tableIntD" class="tableIntT sombra tableIntTa">
        ...
        for ($i = 0; $i < count($contratos); $i++) {
            ...
            <tr>
                ...
                <td>
                    <input type="button" id="button" name="1" onclick="validarDatos(``, `I=<?= $var_inf ?>`, `modalVentana`, `View/Contratos/CargoModales.php`)" title="Información Elemento" value="INFORMACION">
                    <input type="button" id="button" name="1" onclick="validarDatos(``, `I=<?= $var_blo ?>`, `modalVentana`, `View/Contratos/CargoModales.php`)" title="Bloquear Elemento" value="BLOQUEAR">
                </td>
                <td>
                    <input type="button" id="button" name="3" onclick="validarDatos(``, `I=<?= $var_mod ?>`, `modalVentana`, `View/Contratos/CargoModales.php`)" title="Modificar Elemento" value="MODIFICAR">
                    <input type="button" id="button" name="3" onclick="validarDatos(``, `I=<?= $var_eli ?>`, `modalVentana`, `View/Contratos/CargoModales.php`)" title="Eliminar" value="ELIMINAR">
                </td>
            </tr>
        <?PHP
    }
    ?>
        <input type="hidden" id="donde" value="Contratos">
